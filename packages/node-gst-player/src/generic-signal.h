//
// Created by Andrei Sarakeev on 08/11/2018.
//

#ifndef NODE_GST_PLAYER_GENERIC_SIGNAL_H
#define NODE_GST_PLAYER_GENERIC_SIGNAL_H
#include <gstreamermm.h>
#include <glibmm.h>

/**
 * signal_callback<void(guint, const Glib::RefPtr<Gst::Caps>&)> signal_wrapper;
 * signal_wrapper("<signal>", <source>).connect(...)
 */
...
#endif //NODE_GST_PLAYER_GENERIC_SIGNAL_H
