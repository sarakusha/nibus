...
var Stela = function Stela(props) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["3006128604", [paddingTop, width, height, backgroundColor, isBold ? 'bold' : 'inherited', titleColor || 'inherited', title ? 'inherit' : 'none', titleSize, nameColor, nameSize, subSize, fontName === 'Ubuntu' ? 'Ubuntu Condensed' : fontName, subColor, priceColor, priceSize]], ["2978175783", [fontName === 'Ubuntu' ? "Ubuntu".concat(isCondensed ? ' Condensed' : '') : fontName, lineHeight]]]) + " " + 'stela',
    __source: {
      fileName: _jsxFileName,
      lineNumber: 27
    },
    ...
    className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["3006128604", [paddingTop, width, height, backgroundColor, isBold ? 'bold' : 'inherited', titleColor || 'inherited', title ? 'inherit' : 'none', titleSize, nameColor, nameSize, subSize, fontName === 'Ubuntu' ? 'Ubuntu Condensed' : fontName, subColor, priceColor, priceSize]], ["2978175783", [fontName === 'Ubuntu' ? "Ubuntu".concat(isCondensed ? ' Condensed' : '') : fontName, lineHeight]]]),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 28
    },
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", {
      ...
      className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["3006128604", [paddingTop, width, height, backgroundColor, isBold ? 'bold' : 'inherited', titleColor || 'inherited', title ? 'inherit' : 'none', titleSize, nameColor, nameSize, subSize, fontName === 'Ubuntu' ? 'Ubuntu Condensed' : fontName, subColor, priceColor, priceSize]], ["2978175783", [fontName === 'Ubuntu' ? "Ubuntu".concat(isCondensed ? ' Condensed' : '') : fontName, lineHeight]]]) + " " + "name",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 36
      },
      ...
      className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["3006128604", [paddingTop, width, height, backgroundColor, isBold ? 'bold' : 'inherited', titleColor || 'inherited', title ? 'inherit' : 'none', titleSize, nameColor, nameSize, subSize, fontName === 'Ubuntu' ? 'Ubuntu Condensed' : fontName, subColor, priceColor, priceSize]], ["2978175783", [fontName === 'Ubuntu' ? "Ubuntu".concat(isCondensed ? ' Condensed' : '') : fontName, lineHeight]]]) + " " + "sub",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 37
      },
      ...
      className: styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a.dynamic([["3006128604", [paddingTop, width, height, backgroundColor, isBold ? 'bold' : 'inherited', titleColor || 'inherited', title ? 'inherit' : 'none', titleSize, nameColor, nameSize, subSize, fontName === 'Ubuntu' ? 'Ubuntu Condensed' : fontName, subColor, priceColor, priceSize]], ["2978175783", [fontName === 'Ubuntu' ? "Ubuntu".concat(isCondensed ? ' Condensed' : '') : fontName, lineHeight]]]) + " " + "price",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 38
      },
    ...
    id: "3006128604",
    dynamic: [paddingTop, width, height, backgroundColor, isBold ? 'bold' : 'inherited', titleColor || 'inherited', title ? 'inherit' : 'none', titleSize, nameColor, nameSize, subSize, fontName === 'Ubuntu' ? 'Ubuntu Condensed' : fontName, subColor, priceColor, priceSize],
    __self: this
  }, ".stela.__jsx-style-dynamic-selector{padding-top:".concat(paddingTop, "px;width:").concat(width, "px;height:").concat(height, "px;background:").concat(backgroundColor, ";color:white;font-weight:").concat(isBold ? 'bold' : 'inherited', ";}h3.__jsx-style-dynamic-selector{color:").concat(titleColor || 'inherited', ";display:").concat(title ? 'inherit' : 'none', ";text-align:center;font-size:").concat(titleSize, "px;}li.__jsx-style-dynamic-selector{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;}li.__jsx-style-dynamic-selector>*.__jsx-style-dynamic-selector{-webkit-align-self:baseline;-ms-flex-item-align:baseline;align-self:baseline;}.name.__jsx-style-dynamic-selector{-webkit-flex:0 0;-ms-flex:0 0;flex:0 0;margin-right:2px;color:").concat(nameColor, ";font-size:").concat(nameSize, "px;}.sub.__jsx-style-dynamic-selector{overflow:hidden;white-space:nowrap;font-size:").concat(subSize, "px;font-weight:normal;font-family:").concat(fontName === 'Ubuntu' ? 'Ubuntu Condensed' : fontName, ",sans-serif;color:").concat(subColor, ";}.price.__jsx-style-dynamic-selector{-webkit-flex:1 0;-ms-flex:1 0;flex:1 0;text-align:right;color:").concat(priceColor, ";font-size:").concat(priceSize, "px;}.neon.__jsx-style-dynamic-selector{-webkit-animation:neon-__jsx-style-dynamic-selector 1.5s ease-in-out infinite alternate;animation:neon-__jsx-style-dynamic-selector 1.5s ease-in-out infinite alternate;}@-webkit-keyframes neon-__jsx-style-dynamic-selector{from{text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #fff, 0 0 40px #f17, 0 0 70px #f17, 0 0 80px #f17, 0 0 100px #f17, 0 0 150px #f17;}to{text-shadow: 0 0 5px #fff, 0 0 10px #fff, 0 0 15px #fff, 0 0 20px #F17, 0 0 35px #F17, 0 0 40px #F17, 0 0 50px #F17, 0 0 75px #F17;}}@keyframes neon-__jsx-style-dynamic-selector{from{text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #fff, 0 0 40px #f17, 0 0 70px #f17, 0 0 80px #f17, 0 0 100px #f17, 0 0 150px #f17;}to{text-shadow: 0 0 5px #fff, 0 0 10px #fff, 0 0 15px #fff, 0 0 20px #F17, 0 0 35px #F17, 0 0 40px #F17, 0 0 50px #F17, 0 0 75px #F17;}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/sarakusha/WebstormProjects/@nata/packages/stela/pages/index.tsx */")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(styled_jsx_style__WEBPACK_IMPORTED_MODULE_0___default.a, {
    id: "2978175783",
    dynamic: [fontName === 'Ubuntu' ? "Ubuntu".concat(isCondensed ? ' Condensed' : '') : fontName, lineHeight],
    __self: this
  }, "*{margin:0;padding:0;box-sizing:border-box;}html,body{-webkit-font-smoothing:antialiased;font-family:".concat(fontName === 'Ubuntu' ? "Ubuntu".concat(isCondensed ? ' Condensed' : '') : fontName, ",sans-serif;height:100%;overflow:hidden;line-height:").concat(lineHeight, ";}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/sarakusha/WebstormProjects/@nata/packages/stela/pages/index.tsx */")));
};
